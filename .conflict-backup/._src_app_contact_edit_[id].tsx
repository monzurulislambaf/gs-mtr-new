...
=======
          ...
          <TextInput label="DESIGNATION" value={form.DESIGNATION} onChangeText={(t) => updateField('DESIGNATION', t)} mode="outlined" style={styles.input} />
          <TextInput label="BRANCH / TRADE" value={form['BRANCH / TRADE']} onChangeText={(t) => updateField('BRANCH / TRADE', t)} mode="outlined" style={styles.input} />
          <TextInput label="OFFICE" value={form.OFFICE} onChangeText={(t) => updateField('OFFICE', t)} mode="outlined" style={styles.input} />
          <TextInput label="RESIDENCE" value={form.RESIDENCE} onChangeText={(t) => updateField('RESIDENCE', t)} mode="outlined" style={styles.input} />
>>>>>>> 976be18251497c7c9549b752f4e9178f5f669dd0
